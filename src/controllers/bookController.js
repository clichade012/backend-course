...
const createBook= async function (req, res) {
    let data= req.body
   let savedData= await BookModel.create(data).count()
...
const getinputyear = async function( req,res) {
    let year= req.body
   let savedyear = await BookModel.find(year)
 ...
 const getINRBooks = async function( req,res){
    ...
    let allINR = await BookModel.find( { $or : [{prices:{indianPrice:"100INR"}},{prices:{indianPrice:"200INR"}},{prices:{indianPrice:"500INR"}}]} )
     res.send({msg:allINR})
}
...
module.exports.year=getinputyear
module.exports.horse = getparticularBook 
module.exports.kool=getINRBooks
module.exports.randombk=getRandomBook