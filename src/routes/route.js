...
router.get("/sol1",function(req,res){
    ...
    for ( let i=0; i<array.length; i++){
       ...
       let consecutivenumber = lastdigit* (lastdigit+1) / 2
       let missingnumber = consecutivenumber-Sum
    ...
    router.get('/sol2',function(req,res){
        ...
        let lastdigit = array.pop()
        let consecutivenumber = (ben + 1) * (firstdigit + lastdigit) / 2
        let missingNumber = consecutivenumber - sum 
